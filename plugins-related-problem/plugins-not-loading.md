...
Dealing with plugins is kind of annoying and hard to debug in some case. If it bootloop we need to find the culprit/s with a witch hunt. But fortunately with the community experience we can narrow down the issues.  
